...
int main(void)
{
  ...
  printf("start\n");
  FILE *pOutputFile = fopen("./graphics/SoulTrain/00150.h", "w");
  FILE *pOutputSrcFile = fopen("./graphics/SoulTrain/00150.c", "w");
  FILE *pInputFile = fopen("./graphics/SoulTrain/vlcsnap-00150.h", "r");
  int inLine = 0;
  ...
  // just corped
  pOutputFile = fopen("./graphics/SoulTrain/00150-v2.h", "w");
  ...
  pOutputFile = fopen("./graphics/SoulTrain/00150-v3.h", "w");
  ...
  pOutputFile = fopen("./graphics/SoulTrain/00150-v4.h", "w");
  fprintf(pOutputFile, "unsigned char image00150[800 * 480 * 4 + 1] = {\n");
  for (int j = 0; j < 360; j++)
  {
    for (int i = 20; i < 620; i++)
